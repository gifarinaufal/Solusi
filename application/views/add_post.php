      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href=" add_post"><span class="nav-icon"></span> Add New</a></li>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Add Post</span></li>
            </ol>
          </nav>
        </div>
      </header>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  <h4 class="card-title mb-0">Add posts</h4>
                 </div>
               <div>
            ...
            <div class="tab-content rounded-bottom">
                    ...
                    <?php endif; ?>
                         ...
                         <div class="mb-3">
                          ...
                          <input class="form-control" id="exampleFormControlInput1"  placeholder="Judul Konten" name="title">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="exampleFormControlInput1"  placeholder="Kategori" name="category">
                        </div>
