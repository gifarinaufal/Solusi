      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href=" edit_post"><span class="nav-icon"></span> Add New</a></li>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  <h4 class="card-title mb-0">Edit posts</h4>
                 </div>
               <div>
            ...
            <div class="tab-content rounded-bottom">
                    ...
                    <?php endif; ?>
                         ...
                         <div class="mb-3">
                          ...
                          <input class="form-control" id="exampleFormControlInput1"  placeholder="Judul Konten" name="title" value="<?php echo $data['Title'];?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="exampleFormControlInput1"  placeholder="Kategori" name="category" value="<?php echo $data['Category'];?>">
                        </div>
                        
                           <div class="col-auto"></div>
                        <center>
                        <button class="btn btn-primary mb-3" name="id" value="1" type="submit">Publish</button>
                        <button class="btn btn-primary mb-3" name ="id" value="2"type="submit">Draft</button>
      </center>                        
    </div>        
                            <?php endforeach;?>
    </form>
